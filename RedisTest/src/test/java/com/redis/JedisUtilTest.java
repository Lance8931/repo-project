...
public class JedisUtilTest {
	...
	@Before
	public void setUp() {
		pool = new JedisPool(new JedisPoolConfig(), "192.168.10.23");
		jedis = pool.getResource();
	}

	@Test
	public void testGet() {
		System.out.println(jedis.get("li"));
	}
	...
	public void testList() {
		...
		// 第一个是key，第二个是起始位置，第三个是结束位置，jedis.llen获取长度 -1表示取得最后一个
		System.out.println(jedis.lrange("java framework", 0, -1));
	}
