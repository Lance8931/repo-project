...
/* 57 */     method.setName(this.introspectedTable.getUpdateByPrimaryKeySelectiveStatementId());
/*    */ 
...
/*    */ 
/* 64 */     if (this.context.getPlugins().clientUpdateByPrimaryKeySelectiveMethodGenerated(method, interfaze, this.introspectedTable))
/*    */     {
 ...
 * Qualified Name:     org.mybatis.generator.codegen.mybatis3.javamapper.elements.UpdateByPrimaryKeySelectiveMethodGenerator
