...
/*     */ 
/*  58 */     String rootClass = getRootClass();
/*  59 */     if (this.introspectedTable.getRules().generateBaseRecordClass())
/*  60 */       topLevelClass.setSuperClass(this.introspectedTable.getBaseRecordType());
/*     */     else {
/*  62 */       topLevelClass.setSuperClass(this.introspectedTable.getPrimaryKeyType());
/*     */     }
/*     */ 
 ...
 * Qualified Name:     org.mybatis.generator.codegen.mybatis3.model.RecordWithBLOBsGenerator
