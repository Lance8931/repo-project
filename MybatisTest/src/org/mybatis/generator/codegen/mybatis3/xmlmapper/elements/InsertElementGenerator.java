...
/*     */ 
/*  52 */     answer.addAttribute(new Attribute("parameterType", parameterType.getFullyQualifiedName()));
/*     */ 
...
/*     */       }
/*     */ 
/*  90 */       insertClause.append(MyBatis3FormattingUtilities.getEscapedColumnName(introspectedColumn));
/*     */ 
/*  92 */       valuesClause.append(MyBatis3FormattingUtilities.getParameterClause(introspectedColumn));
/*     */ 
/*  94 */       if (iter.hasNext()) {
 ...
 * Qualified Name:     org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertElementGenerator
