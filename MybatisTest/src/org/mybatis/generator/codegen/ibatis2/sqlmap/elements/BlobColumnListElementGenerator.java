...
/* 51 */       sb.append(Ibatis2FormattingUtilities.getSelectListPhrase((IntrospectedColumn)iter.next()));
/*    */ 
/* 54 */       if (iter.hasNext()) {
/* 55 */         sb.append(", ");
/*    */       }
 ...
 * Qualified Name:     org.mybatis.generator.codegen.ibatis2.sqlmap.elements.BlobColumnListElementGenerator
