...
/*     */ 
/*  45 */     answer.addAttribute(new Attribute("parameterClass", this.introspectedTable.getBaseRecordType()));
/*     */ 
...
/*     */ 
/*  64 */       sb.append(Ibatis2FormattingUtilities.getEscapedColumnName(introspectedColumn));
/*     */ 
/*  66 */       sb.append(" = ");
/*  67 */       sb.append(Ibatis2FormattingUtilities.getParameterClause(introspectedColumn));
/*     */ 
/*  70 */       if (iter.hasNext()) {
/*  71 */         sb.append(',');
/*     */       }
...
/*     */       }
/*     */ 
/*  94 */       sb.append(Ibatis2FormattingUtilities.getEscapedColumnName(introspectedColumn));
/*     */ 
/*  96 */       sb.append(" = ");
/*  97 */       sb.append(Ibatis2FormattingUtilities.getParameterClause(introspectedColumn));
/*     */ 
 ...
 * Qualified Name:     org.mybatis.generator.codegen.ibatis2.sqlmap.elements.UpdateByPrimaryKeyWithoutBLOBsElementGenerator
