...
/*  47 */     sb.append(this.daoTemplate.getUpdateMethod(this.introspectedTable.getIbatis2SqlMapNamespace(), this.introspectedTable.getUpdateByPrimaryKeySelectiveStatementId(), "record"));
/*     */ 
/*  50 */     method.addBodyLine(sb.toString());
/*     */ 
/*  52 */     method.addBodyLine("return rows;");
/*     */ 
/*  54 */     if (this.context.getPlugins().clientUpdateByPrimaryKeySelectiveMethodGenerated(method, topLevelClass, this.introspectedTable))
/*     */     {
...
/*     */ 
/*  67 */     if (this.context.getPlugins().clientUpdateByPrimaryKeySelectiveMethodGenerated(method, interfaze, this.introspectedTable))
/*     */     {
...
/*  91 */     method.setName(getDAOMethodNameCalculator().getUpdateByPrimaryKeySelectiveMethodName(this.introspectedTable));
/*     */ 
 ...
 * Qualified Name:     org.mybatis.generator.codegen.ibatis2.dao.elements.UpdateByPrimaryKeySelectiveMethodGenerator
