...
/*  50 */     sb.append(this.daoTemplate.getUpdateMethod(this.introspectedTable.getIbatis2SqlMapNamespace(), this.introspectedTable.getUpdateByExampleStatementId(), "parms"));
/*     */ 
/*  53 */     method.addBodyLine(sb.toString());
/*     */ 
/*  55 */     method.addBodyLine("return rows;");
/*     */ 
/*  57 */     if (this.context.getPlugins().clientUpdateByExampleWithoutBLOBsMethodGenerated(method, topLevelClass, this.introspectedTable))
/*     */     {
...
/*  83 */       parameterType = new FullyQualifiedJavaType(this.introspectedTable.getBaseRecordType());
/*     */     }
/*     */     else {
/*  86 */       parameterType = new FullyQualifiedJavaType(this.introspectedTable.getPrimaryKeyType());
/*     */     }
/*     */ 
...
/*  95 */     method.setName(getDAOMethodNameCalculator().getUpdateByExampleWithoutBLOBsMethodName(this.introspectedTable));
/*     */ 
 ...
 * Qualified Name:     org.mybatis.generator.codegen.ibatis2.dao.elements.UpdateByExampleWithoutBLOBsMethodGenerator
