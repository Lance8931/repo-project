...
/* 131 */     indentLevel++;
/*     */ 
/* 133 */     Iterator strIter = this.enumConstants.iterator();
...
/*     */     }
/*     */ 
/* 151 */     Iterator fldIter = this.fields.iterator();
...
/*     */     }
/*     */ 
/* 165 */     Iterator mtdIter = this.methods.iterator();
/* 166 */     while (mtdIter.hasNext()) {
/* 167 */       OutputUtilities.newLine(sb);
/* 168 */       Method method = (Method)mtdIter.next();
/* 169 */       sb.append(method.getFormattedContent(indentLevel, false));
/* 170 */       if (mtdIter.hasNext()) {
...
/*     */     }
/*     */ 
/* 179 */     Iterator icIter = this.innerClasses.iterator();
...
/*     */     }
/*     */ 
/* 193 */     Iterator ieIter = this.innerEnums.iterator();
 ...
 * Qualified Name:     org.mybatis.generator.api.dom.java.InnerEnum
