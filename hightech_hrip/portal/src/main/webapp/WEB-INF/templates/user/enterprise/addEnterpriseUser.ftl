...
<head>
    ...
    <@js src="js/siping/admin/user/enterprise-addUser.js" />
    <style type="text/css">
...
<div class="container-fluid">
    <form class="form-horizontal" role="form" method="post" id="enterprise_addForm" target="post_frame"
        action="<@url value='/enterprise/add'/>" data-bv-message="必填字段" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="radio" name="isHightech" value="1"/>是
        ...
        <div class="form-group">
            <div class="inline-row">
                <label class="col-sm-4 control-label">营业额</label>
                <div class="col-sm-4">
                    <input type="text" id="turnover" name="turnover" class="form-control input-sm" 
                    placeholder="请输入营业额">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="employees" name="employees" class="form-control input-sm" 
                    placeholder="请输入公司规模">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    name='businessScope' type="text" placeholder="请输入业务范围"> 
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    name='product' type="text" placeholder="请输入产品介绍"> 
                </div>
            </div>
        </div>
