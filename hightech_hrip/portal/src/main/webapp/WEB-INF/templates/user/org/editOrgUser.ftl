...
<div class="container-fluid">
    <form class="form-horizontal" role="form" method="post" id='org_editForm' target="post_frame"
        action="<@url value='/userOrg/update'/>" data-bv-message="必填字段" enctype="multipart/form-data">
        <div class="form-group">
            <div class="inline-row">
                <label class="col-sm-4 control-label ">用户名</label>
                <div class="col-sm-4">
                    <input type="text" id="username" name="username" class="form-control input-sm" 
                        readonly="readonly" placeholder="请输入用户名" value="${org.username!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="orgCode" name="orgCode" class="form-control input-sm" 
                    value="${org.orgCode!''}" required placeholder="请输入组织机构代码">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    required placeholder="工商注册号" value="${org.registeredNo!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="orgName" name="orgName" class="form-control input-sm" 
                        required placeholder="企业名称" value="${org.orgName!''}">
                </div>
            </div>
        </div>
            ...
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <select class="form-control input-sm" id="orgTypeId" name="orgTypeId">
                        <option value="${org.orgTypeId!''}"></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    placeholder="请输入公司主营行业" value="${org.mainIndustry!''}">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    placeholder="请输入公司所属次要行业" value="${org.secondaryIndustry!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="secondaryIndustry" name="secondaryIndustry" class="form-control input-sm" 
                    placeholder="请输入公司规模" value="${org.secondaryIndustry!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    value="${org.street!''}" placeholder="请输入企业注册街道">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    name='orgProfile' type="text" placeholder="企业简介" value="${org.orgProfile!''}"> 
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="contacts" name="contacts" class="form-control input-sm" 
                    placeholder="联系人" value="${org.contacts!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="telephone" name="telephone" class="form-control input-sm"
                    value="${org.telephone!''}" placeholder="联系电话">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="cellphone" name="cellphone" class="form-control input-sm" 
                    value="${org.cellphone!''}" placeholder="请输入手机号码">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    value="${org.email!''}" placeholder="邮箱">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="postcode" name="postcode" class="form-control input-sm" 
                        placeholder="邮编" value="${org.postcode!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="website" name="website" class="form-control input-sm" 
                    value="${org.website!''}" placeholder="网址">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    ...
                    value="${org.address!''}" placeholder="请输入公司地址">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="hrContacts" name="hrContacts" class="form-control input-sm" 
                    value="${org.hrContacts!''}" placeholder="请输入招聘联系人">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="hrTelephone" name="hrTelephone" class="form-control input-sm" 
                        placeholder="请输入招聘联系电话" value="${org.hrTelephone!''}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="cellphone" name="cellphone" class="form-control input-sm" 
                    value="${org.cellphone!''}" placeholder="请输入招聘联系手机号">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="inline-row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="hrEmail" name="hrEmail" class="form-control input-sm" 
                    value="${org.hrEmail!''}" placeholder="请输入招聘联系邮箱">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
              <div class="col-sm-offset-5 col-sm-2">
                 <button  type="button" onclick="update();" class="btn btn-success btn-block">提交</button>
              </div>
           </div>
