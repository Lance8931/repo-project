...
<section id="main">
    <aside id="aside">
        <h3>企业入园</h3>
        <ul id="nav">
            <li class="active"><a href="#article-1">入园优势</a></li>
            <li><a href="#article-2">入园政策</a></li>
            <li><a href="#article-3">入园指南</a></li>
            <li><a href="#article-4">入住企业</a></li>
        </ul>
    </aside>
...
<script>
   ...
   $('#aside').find('li').click(function(){
    ...
    $(function(){
        $.getJSON(createUrl('article/getIntroContentList?type=get-in-park'),
                function(results){
