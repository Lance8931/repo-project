package com.siping.hrip.common.freemarker;
...
import com.siping.hrip.common.constant.SecuritySessionConstants;
...
public class ButtonTag extends TagSupport implements TemplateDirectiveModel {
    ...
    private String getPageButtons(String style, String required, Integer userId) {
        ...
        // GetButtonPermissionResponse permission = getUserBtnPermission(userId,
        // path);
        ...
        // btnHtml += "<button id=\"tag_add_button\" type=\"button\" class=\"" +
        // style + "\" onclick=\"spf_add();\" >添加</button>";
        // } else if (permission.getDelBtn() == 1) {
        // btnHtml +=
        // "<button id=\"tag_delete_button\" type=\"button\" class=\"" + style +
        // "\" onclick=\"spf_delete();\" >删除</button>";
        // } else if (permission.getEditBtn() == 1) {
        // btnHtml += "<button id=\"tag_edit_button\" type=\"button\" class=\""
        // + style + "\" onclick=\"spf_edit();\" >编辑</button>";
        // } else if (permission.getPrintBtn() == 1) {
        // btnHtml += "<button id=\"tag_print_button\" type=\"button\" class=\""
        // + style + "\" onclick=\"spf_print();\" >打印</button>";
        // }
        ...
        // btnHtml += "<button id=\"tag_edit_button\" type=\"button\" class=\""
        // + style + "\" onclick=\"spf_edit();\" >编辑</button>";
        // } else if (require.contains("print") && permission.getPrintBtn() ==
        // 1) {
        // btnHtml += "<button id=\"tag_print_button\" type=\"button\" class=\""
        // + style + "\" onclick=\"spf_print();\" >打印</button>";
        // }
    ...
    // private GetButtonPermissionResponse getUserBtnPermission(Integer userId,
    // String path) {
    // permissionService =
    // SpringObjectFactory.getInstance().getBean(PermissionService.class);
    // GetButtonPermissionResponse btnPermission =
    // permissionService.getButtonPermissions(userId, path);
