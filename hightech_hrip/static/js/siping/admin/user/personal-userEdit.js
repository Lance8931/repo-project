...
function save(){
	$("#personal_user_edit_form").data("bootstrapValidator").validate();
    if(!$("#personal_user_edit_form").data("bootstrapValidator").isValid()){
        return;
    }
    $("#personal_user_edit_form").ajaxSubmit({
...
function bootstrapValidatorForm(){
  $('#personal_user_edit_form').bootstrapValidator({
