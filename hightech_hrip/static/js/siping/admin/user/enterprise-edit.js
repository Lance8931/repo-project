...
//保存
function update(){
    $('#enterprise_editForm').data('bootstrapValidator').validate();
    if($('#enterprise_editForm').data('bootstrapValidator').isValid()){
        $('#enterprise_editForm').ajaxSubmit({
            success: function (data) {
                if(data.success){
...
function bootstrapValidatorForm(){
    $('#enterprise_editForm').bootstrapValidator({
